...
declare module "nextjs-routes" {
  ...
  export type Route =
    | StaticRoute<"/api/getActiveSubscription">
    | StaticRoute<"/confirm-email">
    | DynamicRoute<"/dashboard/companies/[id]", { "id": string }>
    | StaticRoute<"/dashboard/companies">
    | StaticRoute<"/dashboard">
    | StaticRoute<"/dashboard/individuals">
    | StaticRoute<"/">;
